...
object Main {
  ...
  def main(args:Array[String]) {
    ...
    def webScrapNBALeagueLeaders(seasonUrl:String) = {
    ...
    //we inject into a TreeMap to maintain the order
    TreeMap(webScrapNBALeagueLeaders("http://espn.go.com/nba/statistics/player/_/stat/scoring-per-game/sort/avgPoints/year/2013/").toSeq:_*).foreach(println)
